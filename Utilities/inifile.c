...
*/
int read_profile_string( const char *section, char *key,char *value, 
...
*/
int read_profile_int( const char *section, char *key,int default_value, 
				const char *file)
{
	char value[32] = {0};
...
float read_profile_float( const char *section, char *key,int default_value, 
				const char *file)
{
	char value[32] = {0};
	if(!read_profile_string(section,key,value, sizeof(value),NULL,file))
